...
const FOLDERS = [
  ...
  },
  {
    id: "somethin",
    name: "Somethin'",
    caption: "Cafe brand: menu system, food photography, IG",
    badge: "/branding/somethin-logo.webp",
    items: [
      { src: "/branding/somethin-1.webp", width: 1100, height: 1400, alt: "Somethin' matcha collection menu poster with three branded striped cups", caption: "Matcha collection: menu system and cup identity" },
      { src: "/branding/somethin-2.webp", width: 1100, height: 1400, alt: "Somethin' rice bowl menu poster with three branded cups", caption: "Rice bowl menu with branded to-go packaging" },
      { src: "/branding/somethin-3.webp", width: 1100, height: 1400, alt: "Somethin' katsu menu poster with four plated katsu sets", caption: "Menu photography and food styling, shot in-house" },
      { src: "/branding/somethin-4.webp", width: 1100, height: 1400, alt: "Somethin' noodles menu poster with three branded bowls", caption: "One poster system across seven menu categories" },
    ],
  },
];
...
function BoardOverlay({ folder, reduce, onClose }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center justify-between gap-4 border-b border-white/60 px-6 py-4">
          <div className="flex min-w-0 items-center gap-3">
            {folder.badge && (
              <img
                ...
                width={44}
                height={44}
                className="h-11 w-11 flex-none rounded-full object-cover ring-2 ring-white shadow-[0_4px_10px_rgba(26,46,102,0.22)]"
              />
            )}
