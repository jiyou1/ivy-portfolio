  ...
  return (
    <div className="relative mx-auto h-[1024px] w-[1440px] overflow-hidden bg-white">
      ...
      <video
        ...
        muted
        playsInline
        // bg-removed export is flattened to pure white (mp4 can't carry alpha);
        // multiply knocks it out, brightness(1.02) guards h264 compression
        // wobble around the white. A yuva420p webm would drop both hacks.
